...
def plot_icminmax(sq1_safb_servo_biases_uA, sq1_safb_servo_mins_sa_in_uA, sq1_safb_servo_maxs_sa_in_uA,
    ...
    plt.plot(sq1_safb_servo_biases_uA, sq1_safb_servo_biases_uA, label='Slope=1')
...
def plot_icminmax_col(last_fig, col, ic_params, ic_params2 = None, ctime=None,  
    ...
    if(last_fig):
        ...
        if(ic_params2 is not None):
            ...
            s1b_minmax_ax.plot([0, sq1_safb_servo_biases_uA[-1]], [start_sq1imod_uA, start_sq1imod_uA ],  color='deeppink', lw=3)
        ...
        s1b_minmax_ax.set_xlabel('SQ1 Total Bias Current ($\mu$A)', fontsize=18)
