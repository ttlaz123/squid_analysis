...
class SmallMCEFile:
    ...
    def ReadRaw(self, count=None, start=0, raw_frames=False):
        ...
        c = int(count*f_dwords)
        a = numpy.fromfile(file=fin, dtype='<i4',  count=c)
        n_frames =int(len(a) / f_dwords)
    ...
    def Read(self, count=None, start=0,
        ...
        if dm_data.raw:
            ...
            offset = int(start - cc_start * pack_factor)
            data = data[:, offset:int(offset+count)]
